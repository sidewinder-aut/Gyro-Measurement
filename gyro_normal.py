...
#                        SHORT DESCRIPTION: 
#                        ==================
# Subroutine reads the data of the gyroscope. The bank angle in x- and y-direction can be deterimined by the gyroscope 
# sensor or by using the output of the accelerometer.
#-----------------------------------------------------------------------------------------------------------------------------------------------------------
#=                     RECORD OF REVISIONS:
#                      ====================
...
#--- Reading the output from the gyro file is taken from: http://blog.bitify.co.uk/2013/11/reading-data-from-mpu-6050-on-raspberry.html
